    ...
    <main className="page">
      ...
      <section className="intro">
        <div className="intro__inner">
          ...
          <p className="global__intro-text">Десерты, которые несут максимум пользы благодаря полностью натуральному составу и подходят тем, кто избирательно подходит к питанию. Здесь вы найдете десерты, которые подходят аллергикам, постящимся, вегетарианцам и веганам, да и просто тем, кто придерживается здорового питания. При этом каждый десерт обладает полноценным сбалансированным вкусом.</p>
        </div>
      </section>
